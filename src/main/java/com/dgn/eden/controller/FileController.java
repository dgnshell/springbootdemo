...
//        定义文件的唯一标识（前缀）
        ...
        String rootFilePath = System.getProperty("user.dir")+"/src/main/resources/files/"+flag+"_"+originalFilename;//获取文件上传的路径
        try {
    ...
    public void getFiles(@PathVariable String flag, HttpServletResponse response){
        ...
        String basePath = System.getProperty("user.dir")+"/src/main/resources/files/";//文件路径
